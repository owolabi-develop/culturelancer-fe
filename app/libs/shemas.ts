...
export const forgotPasswordSehema = z.object({
  email: emailSchema,
});
...
export const projectShema = z.object({
  project_title: z
    .string({ required_error: "Project Title is required", invalid_type_error: "invalid type input for Project Title" })
...
export const jobPostingSchema = z
  .object({
    ...
    category: z
      .string({ required_error: "Category is required", invalid_type_error: "invalid type input for Category" })
    ...
    experienceLevel: z
      .array(z.string().min(1, { message: "Experience Level name is required" }))
      .min(1, { message: "At least three is required must be provided." }),

    jobtype: z
      .array(z.string().min(1, { message: "job type Level name is required" }))
      .min(1, { message: "At least three is required must be provided." }),
