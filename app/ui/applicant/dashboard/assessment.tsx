    ...
    <section className="md:grid grid-cols-1 p-20 w-full justify-around">
      ...
      <div className="w-full">
        <h1 className="text-3xl font-bold md:text-3xl block text-black">
          Your Skill Assessment Progress
        </h1>
        <p className="mt-3">
          Track your progress accross various skill categories and explore
          personalized recommededations to enhance your capatibilities.
        </p>
        ...
        <div className="space-y-4 xl:space-y-0 md:grid grid-cols-4 gap-3 mt-4">
          ...
          <div className="bg-[lightgray] drop-shadow-lg p-3 rounded">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
              <div
                className={`bg-[gray] h-2.5 rounded-full w-[${assessemtScore}%]`}
              ></div>
            </div>
        ...
        <Link href="/hire">
          {" "}
          <button className=" bg-black text-white rounded py-3 px-5 mt-5">
            View Full Report
          </button>
        </Link>
      </div>
      ...
      <div className="w-full mt-5">
        ...
        <div className="rounded bg-[lightgray] p-10 w-full mt-5">
          ...
          <div className="p-3">
            <h1>
              Your performance in skill category 1 is stronger. Consider advance
              course to further excel
            </h1>
            <h1>
              Your performance in skill category 1 is stronger. Consider advance
              course to further excel
      ...
      <div className="w-full mt-5 mb-28">
        ...
        <div className="space-y-4 xl:space-y-0 md:grid grid-cols-3 gap-3 mt-4">
          ...
          <div className="drop-shadow-lg p-5 rounded border">
            <div className={`bg-[lightgray] rounded text-center p-20`}>
              {" "}
              Course Image
            </div>
            ...
            <p className="my-3">
              {" "}
              Enhance your Experties in Skill Category 1 with this advance
              course.
            </p>
            ...
            <div className="space-x-4 ">
              <Link href="/hire">
                {" "}
                <button className=" bg-[lightgray] text- rounded py-2 px-5">
                  Learn More
                </button>
              </Link>
              <Link href="/work">
                <button className="rounded py-2 px-5 text-[white] bg-[#131313] border border-current">
                  View More
                </button>
              </Link>
            </div>
