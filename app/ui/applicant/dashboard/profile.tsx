        ...
        <div className="space-y-5 md:w-[30%] md:flex flex-col ">
          ...
          <div className="bg-white drop-shadow-lg w-full p-3 rounded">
            ...
            <div className="py-3 px-4 bg-[#efefef] rounded my-5">
              <p className="py-1 px-2 text-black">
                John is a execptional ui designer with a keen eye for details
              </p>
...
function ExperienceContainer() {
  ...
  const { data, error, isLoading } = useApplicantWorkExperience();
...
function CertificateContainer() {
  ...
  const { data, error, isLoading } = useAwards();
  ...
  return (
    <>
      <div className="bg-white drop-shadow-lg w-full p-3 rounded flex-none">
        ...
        <div className="px-3">
          <Link href={`/applicant/settings/awards-certifications/${id}`}>
            {" "}
            <button className="border rounded py-1 px-2">
              Add Certificate
            </button>
    ...
    <>
      ...
      <div className="bg-white drop-shadow-lg w-full rounded p-3 py-5">
        ...
        <div className="w-full overflow-hidden [&>*]:font-bold [&>*]:py-2 [&>*]:px-[0.35rem] md:[&>*]:py-2 md:[&>*]:px-[0.35rem] [&>*]:my-1 [&>*]:mx-1 md:[&>*]:my-1 md:[&>*]:mx-1  ">
          {data &&
            data?.map((skills: SkillI) => (
              <button key={skills.id} className="bg-[lightgray] rounded-full">
                {" "}
...
function ProjectsContainer() {
  ...
  const { data, error, isLoading } = useApplicantProjects();
            ...
            data.map((projects: projectI) => (
              ...
              >
                {projects.project_image ? (
                  ...
                  <div className="w-full h-28 py-6 text-center">
                    No image available
                  </div>
                )}
                ...
                <div className="py-2 px-3 [&>*]:break-words [&>*]:text-sm border-t-2">
                  ...
                  <div className="my-4">
                    <button className="py-2 px-2 mx-2 border rounded-lg hover:bg-slate-200 [&>*]:text-sm drop-shadow-lg">
                      <a href={projects.project_links_github}>View github</a>
                    </button>
                    <button className="py-2 px-2 mx-2 border rounded-lg hover:bg-slate-200 [&>*]:text-sm drop-shadow-lg">
                      <a href={projects.project_links_live_demo}>
                        View live Demo
                      </a>
                    </button>
                  </div>
