...
export default function PersonalDetailAndSkills(){
  const { register, handleSubmit, formState: { errors } } = useForm<Inputs>({resolver:zodResolver(personalDatailSkill)});
            ...
            <div className="md:grid grid-cols-1 py-5 px-5">
                ...
                <div className="w-full rounded px-5 py-5 bg-white drop-shadow-lg ">
                    ...
                    <div className="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" id="first_name" {...register('firstName')} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 "/>
                            <p className='text-sm text-red-500'>{errors.firstName?.message}</p>
                        </div>

                        <div>
                            <label htmlFor="LastName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last Name</label>
                            <input type="text" id="LastName" {...register('lastName')} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 "/>
                        ...
                        <div>
                            ...
                            <input type="text" id="DisplayName" {...register('displayName')}  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5"/>
                        ...
                        <div>
                            ...
                            <input type="text" id="PhoneNumber" {...register('phoneNumber')} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 " />
                ...
                <div className="flex items-center justify-center w-full">
                    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full  border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                        ...
                        <input id="dropzone-file" {...register('profile_photo')} type="file" className="hidden" />
                ...
                <div>
                <h1 className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Resume</h1>
                ...
                <div className="flex items-center justify-center w-full">
                    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full  border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                        ...
                        <input id="dropzone-file" {...register('resume')} type="file" className="hidden" />
                        <p className='text-sm text-red-500'></p>
                    </label>
                </div> 
                ...
                <textarea id="description" {...register('description')} rows={4} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300" placeholder="Tell us more about your self"></textarea>
                ...
                <textarea id="language" {...register('language')} rows={4} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 "></textarea>
                ...
                <div className="w-full md:w-[70%] rounded px-5  bg-white drop-shadow-lg mt-10 [&>*]:my-4 m-auto md:flex justify-between ">
                    ...
                    <div className="">
                        <button type='submit' className="bg-[#727272] py-2 px-3 md:px-5 md:py-3 rounded text-white mb-5 md:mb-0">Save & Update</button>
                    </div>
