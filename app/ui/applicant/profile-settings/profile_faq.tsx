...
export default function ProfileFaq() {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<Inputs>({ resolver: zodResolver(profileFaq) });
      ...
      <div className="md:grid grid-cols-1 py-5 px-5">
          ...
          <div className="w-full rounded px-5 py-5">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm my-2">
                Add common question and answer that highlight your experties or
                unique skills
              </p>
              ...
              <div className="my-5">
                <button
                  type="submit"
                  className="bg-[#7e7d7d] rounded py-3 px-5 text-white"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
        ...
        <div className="w-full rounded px-5 py-5 bg-white drop-shadow-lg my-5 [&>*]:my-4">
          <p className="text-xl font-semibold my-2">
            What is your primary area of experties
          </p>

          <p className="text-sm my-2">
            My primary area of experties is web developement, with a focus on
