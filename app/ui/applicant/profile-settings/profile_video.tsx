        ...
        <section className="w-full ">
            <div className="md:grid grid-cols-1 py-5 px-5">
                ...
                <div>
                    ...
                    <div className="flex">
                    <input type="url" id="CurrentMayor" name="Quote" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-2.5 w-[80%]"required placeholder="Paste video URL here" />
