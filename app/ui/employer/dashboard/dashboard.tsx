        ...
        <section className="md:grid grid-cols-1 p-20 w-full justify-around">
            ...
            <div className="text-center">
                ...
                <div>
                    ...
                    <input type="search" id="CurrentMayor" name="Quote" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-2.5 w-[50%]"required placeholder="Search ...." />
                    <button className="bg-[#727272]  rounded text-white mx-2 px-5 text-center">Post a Job</button>
                ...
                <div className="w-full md:w-[70%] px-5">
                    ...
                    <div className="bg-white drop-shadow-lg rounded w-full [&>*]:my-2 mt-4">
                        ...
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tr className="text-left [&>*]:border-t-2 border-slate-100 [&>*]:py-3 [&>*]:px-5 rounded-full cursor-pointer hover:bg-slate-200 ">
                                    <td className="flex w-full">
                                        ...
                                        <div className=""><p className="leading-10">Owolabi Akintan</p></div>
                                    </td>
                                    <td>Senior Developer</td>
                                    <td><span className="py-1 px-1 bg-slate-100 rounded">Shortlisted</span></td>
                                </tr>
                                ...
                                <tr className="text-left [&>*]:border-t-2 border-slate-100 [&>*]:py-3 [&>*]:px-5 rounded-full cursor-pointer hover:bg-slate-200 ">
                                    <td className="flex w-full">
                                        <div className="bg-gray-200 rounded-full w-10 h-10 mr-2"></div>
                                        <div className=""><p className="leading-10">Jane Smith</p></div>
                                    </td>
                                    <td>UX Designer</td>
                                    <td><span className="py-1 px-1 bg-slate-100 rounded">Reviewed</span></td>
                                </tr>
                      ...
                      <div className="space-y-3 w-full my-4 md:grid grid-cols-2 gap-3 md:space-y-0">
                        ...
                        <div className=" bg-white drop-shadow-lg py-3 px-4 [&>*]:my-3 rounded-md">
                            ...
                            <p className="">Skills: <span>Javasecipt</span>,<span>React</span></p>
                 ...
                 {/* job posting summary */}
                  ...
                  <div className="bg-white drop-shadow-lg rounded w-full py-4 px-3 [&>*]:my-2 mt-4">
                    <h1 className="text-xl font-bold">Senior Developer</h1>
                    <p>Posted: Jan 15, 2025</p>
                    <p>Candidate Applied: 45</p>
                    <p>Statu Active</p>
                  ...
                  <div className="bg-white drop-shadow-lg rounded w-full py-4 px-3 [&>*]:my-2 mt-4">
                    <h1 className="text-xl font-bold">UX Desgner</h1>
                    <p>Posted: Jan 15, 2025</p>
                    <p>Candidate Applied: 45</p>
                    <p>Statu Active</p>
                    <div className="w-full md:w-[55%] flex justify-between">
