                ...
                <input type="file" name="resume" id="resume" className="rounded py-0 px-0 hidden" />
                        ...
                        <div className="flex justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-300">
                              You can use our Ai to Enhance Your Description to
                              get Perfect match for your Project
                            </p>
                          </div>
                  ...
                  <div className="w-full bg-white rounded-lg drop-shadow-lg my-4 py-3 px-3">
                    ...
                    <div className="grid gap-6 mb-6 md:grid-cols-2">
                      {/* experience level */}
                      <div>
                        <h1 className="font-bold text-base my-2">
                          Experience Level
                        </h1>
                        <div className="flex">
                          ...
                          {jobTypeOptions.map((options, index) => (
                            <div key={index} className="flex items-center me-4">
                              <input
                                ...
                                defaultChecked={data?.job_type?.includes(
                                  options
                                )}
                              />
                              <label
                      ...
                      {paymentsTerms.map((options, index) => (
                        <div key={index} className="flex items-center me-4">
                          <input
                            ...
                            required
                            defaultChecked={data?.payments_terms?.includes(
                              options
                            )}
                          />
                          <label
              ...
              <div className="flex mt-2">
                ...
                <div className="flex items-center me-4">
                  ...
                  <div className="w-full my-3 cursor-pointer">
                    <div
                      className="my-2 flex"
                      onClick={toggleAddtionalInformation}
                    >
                        ...
                        {LocationsType.map((options, index) => (
                          <div key={index} className="flex items-center me-4">
                            <input
                              ...
                              defaultChecked={data?.location_type?.includes(
                                options
                              )}
                            />
                            <label
