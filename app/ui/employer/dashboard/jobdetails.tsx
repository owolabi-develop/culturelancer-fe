        ...
        <section className="p-10 px-24 w-full">
          <div>
            ...
            <div className="flex my-2 text-gray-400 w-full">
              ...
              <p className="mr-2">
                {data &&
                  data?.location_type?.map((loca: string) => <>{loca} </>)}
              </p>
              ...
              <p className="ml-2 mr-2">
                {data && data?.job_type?.map((loca: string) => <>{loca} </>)}
              </p>
              <IoIosCheckmarkCircleOutline className="text-xl  text-black" />{" "}
              <p className="ml-2 mr-2">
                {data &&
                  data?.experience_levels.map((loca: string) => <>{loca} </>)}
              </p>
              <FaRegCalendarMinus className="text-xl text-black" />{" "}
              <p className="ml-2 mr-2">
        ...
        <div className="w-full md:flex">
          <div className="w-full md:w-[60%] px-5">
            <div className="bg-white drop-shadow-lg rounded w-full [&>*]:my-2 mt-4 py-2 px-3">
              ...
              <p className=" break-words">{data && data?.description}</p>
            ...
            <div className="bg-white drop-shadow-lg rounded w-full [&>*]:my-2 mt-4 py-2 px-3">
              ...
              <div className="w-full bg-slate-50 rounded md:flex py-2 px-4 [&>*]:mx-1">
                ...
                <div className="[&>*]:my-3 [&>*]:mx-1">
                  <button className="border py-1 px-2 rounded">
                    View Profile
                  </button>
                  <button className="border py-1 px-2 rounded">Message</button>
                  <button className="bg-gray-200 py-1 px-2 rounded">
                    Shortlist
                  </button>
                </div>
              </div>
          ...
          <div className="w-full md:w-[40%] px-5 md:grid grid-cols-1 ">
            ...
            <div className="bg-white drop-shadow-lg rounded w-full py-4 px-3 [&>*]:my-2 mt-4">
              ...
              <div className="w-full [&>*]:w-full [&>*]:my-3 ">
                <button className="bg-gray-200 py-2 px-4 rounded">
                  <Link href={`/employer/dashboard/edit-job/${data?.id}`}>
                    Edit Job
                  </Link>
                </button>
                {data?.status === "closed" ? (
                  ...
                  <>
                    <button
                      ...
                      onClick={async () => closejob(data?.id)}
                    >
                      Close Job
                    </button>
                  </>
                ...
                <button
                  className="border py-2 px-4 rounded bg-red-500 text-white hover:bg-red-600"
                  onClick={async () => deletejob(data?.id)}
                >
                  Delete Job
                </button>
              </div>
