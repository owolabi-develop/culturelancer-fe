...
function DashboardNavbar({profileName}:{profileName:string}) {
  ...
  return (
    ...
    <nav className='px-20 items-center w-full flex justify-between font-semibold'>
      ...
      <div className='md:flex basis-[85%]'>
        ...
        <li className='mr-5'>
              <Link href="/employer/dashboard" className="rounded-lg px-4 py-3 text-slate-700 font-medium hover:bg-[black] hover:text-slate-100">
                Dashboard
              </Link>
            </li>

            <li className='mr-5'>
              <Link href="/employer/dashboard/post-job" className="rounded-lg px-4 py-3 text-slate-700 font-medium hover:bg-[black] hover:text-slate-100">
                Post Job
              </Link>
            </li>

            <li className='mr-5'>
              <Link href="/employer/dashboard/jobs" className="rounded-lg px-4 py-3 text-slate-700 font-medium hover:bg-[black] hover:text-slate-100">
                My Jobs
              </Link>
            </li>

            <li className='mr-5'>
              <Link href="/employer/dashboard/candidates" className="rounded-lg px-4 py-3 text-slate-700 font-medium hover:bg-[black] hover:text-slate-100">
              Candidate
              </Link>
            </li>

            <li className='mr-5'>
              <Link href="/employer/dashboard/membership" className="rounded-lg px-4 py-3 text-slate-700 font-medium hover:bg-[black] hover:text-slate-100">
              Membership
              </Link>
            </li>
        </ul>
        ...
        <div className=' hidden sm:hidden navIcon order-2 basis-[30%] text-right md:flex items-center justify-end'>
            ...
            <div className='logo-text'><p className='leading-10 text-xs'>{profileName}</p></div>
            </Link>
