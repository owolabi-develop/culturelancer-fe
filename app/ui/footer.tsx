...
function Footer() {
  return (
    <footer className="p-20 w-full justify-around bg-primary">
      ...
      <div className="text-center w-full">
        ...
        <p className="text-base md:text-lg text-[#d1d0cd] mt-6">
          &copy; 2025 Culturelancer. All rights Reseverd.{" "}
        </p>
        <Image
          src="/assets/logo.svg"
          width={100}
          height={100}
          alt="logo"
          className="float-right w-12 -mt-6"
        />
      </div>
    </footer>
  );
